...
import * as M from "./mechanism.js?v=3d923acb";
import { createEditor } from "./editor.js?v=3d923acb";
import { createView3D } from "./view3d.js?v=3d923acb";
import { PRESETS, buildPreset } from "./presets.js?v=3d923acb";
import { exportBlenderScript } from "./blender.js?v=3d923acb";
import { exportPrintableParts } from "./print3d.js?v=3d923acb";
import { makeZip } from "./zip.js?v=3d923acb";
import { encode, decode } from "./serialize.js?v=3d923acb";
...
if (assistantHost) {
  import("./assistant.js?v=3d923acb").then(({ mountAssistant }) => {
