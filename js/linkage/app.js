...
import { createEditor } from "./editor.js?v=1ebeecf9";
import { createView3D } from "./view3d.js?v=1ebeecf9";
import { PRESETS, buildPreset } from "./presets.js?v=1ebeecf9";
import { exportBlenderScript } from "./blender.js?v=1ebeecf9";
import { exportPrintableParts } from "./print3d.js?v=1ebeecf9";
import { makeZip } from "./zip.js?v=1ebeecf9";
import { encode, decode } from "./serialize.js?v=1ebeecf9";
...
if (assistantHost) {
  import("./assistant.js?v=1ebeecf9").then(({ mountAssistant }) => {
