...
import { createEditor } from "./editor.js?v=408e651f";
import { createView3D } from "./view3d.js?v=408e651f";
import { PRESETS, buildPreset } from "./presets.js?v=408e651f";
import { exportBlenderScript } from "./blender.js?v=408e651f";
import { exportPrintableParts } from "./print3d.js?v=408e651f";
import { makeZip } from "./zip.js?v=408e651f";
import { encode, decode } from "./serialize.js?v=408e651f";
...
if (assistantHost) {
  import("./assistant.js?v=408e651f").then(({ mountAssistant }) => {
