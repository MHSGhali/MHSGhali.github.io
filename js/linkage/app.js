...
import { createEditor } from "./editor.js?v=e01fefc3";
import { createView3D } from "./view3d.js?v=e01fefc3";
import { PRESETS, buildPreset } from "./presets.js?v=e01fefc3";
import { exportBlenderScript } from "./blender.js?v=e01fefc3";
import { exportPrintableParts } from "./print3d.js?v=e01fefc3";
import { makeZip } from "./zip.js?v=e01fefc3";
import { encode, decode } from "./serialize.js?v=e01fefc3";
...
if (assistantHost) {
  import("./assistant.js?v=e01fefc3").then(({ mountAssistant }) => {
