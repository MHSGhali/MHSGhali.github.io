...
import * as M from "./mechanism.js?v=901aad0b";
import { createEditor } from "./editor.js?v=901aad0b";
import { createView3D } from "./view3d.js?v=901aad0b";
import { PRESETS, buildPreset } from "./presets.js?v=901aad0b";
import { exportBlenderScript } from "./blender.js?v=901aad0b";
import { exportPrintableParts } from "./print3d.js?v=901aad0b";
import { makeZip } from "./zip.js?v=901aad0b";
import { encode, decode } from "./serialize.js?v=901aad0b";
...
if (assistantHost) {
  import("./assistant.js?v=901aad0b").then(({ mountAssistant }) => {
