...
import { createEditor } from "./editor.js?v=4c85dc67";
import { createView3D } from "./view3d.js?v=4c85dc67";
import { PRESETS, buildPreset } from "./presets.js?v=4c85dc67";
import { exportBlenderScript } from "./blender.js?v=4c85dc67";
import { exportPrintableParts } from "./print3d.js?v=4c85dc67";
import { makeZip } from "./zip.js?v=4c85dc67";
import { encode, decode } from "./serialize.js?v=4c85dc67";
...
if (assistantHost) {
  import("./assistant.js?v=4c85dc67").then(({ mountAssistant }) => {
