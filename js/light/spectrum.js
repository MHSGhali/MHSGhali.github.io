...
import { PLANCK_H, LIGHT_C, BOLTZMANN_K, STEFAN_BOLTZMANN, PI, interpTable } from "./core.js?v=3d923acb";
import { CIE_DAYLIGHT_LAMBDA, CIE_S0, CIE_S1, CIE_S2, CIE_DAYLIGHT_COUNT } from "./cie-data.js?v=3d923acb";
