...
import { SPECTRAL_STEP_NM } from "../light/spectrum.js?v=1ebeecf9";
import { cmfXbar, cmfYbar, cmfZbar, xyzToLinearSrgb, srgbEncode } from "../light/color.js?v=1ebeecf9";
import { clamp } from "../light/core.js?v=1ebeecf9";
