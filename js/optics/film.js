...
import { SPECTRAL_STEP_NM } from "../light/spectrum.js?v=281bca3b";
import { cmfXbar, cmfYbar, cmfZbar, xyzToLinearSrgb, srgbEncode } from "../light/color.js?v=281bca3b";
import { clamp } from "../light/core.js?v=281bca3b";
